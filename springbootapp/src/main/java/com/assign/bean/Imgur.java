...
/**
 *  Imgur Bean to populate response data
 * @author admin
 *
 */
public class Imgur {
	...
	/**
	 * @return the account_url
	 */
	public String getAccount_url() {
		return account_url;
	}
	/**
	 * @param account_url the account_url to set
	 */
	...
	/**
	 * @return the in_gallery
	 */
	public Boolean getIn_gallery() {
		return in_gallery;
	}
	/**
	 * @param in_gallery the in_gallery to set
	 */
