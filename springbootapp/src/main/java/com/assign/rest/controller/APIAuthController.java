package com.assign.rest.controller;
...
import com.assign.bean.Imgur;
import com.assign.bean.JsonResponse;
import com.assign.bean.JwtResponse;
import com.assign.bean.LoginForm;
import com.assign.bean.SignUpForm;
import com.assign.bean.jpa.Role;
import com.assign.bean.jpa.RoleName;
import com.assign.bean.jpa.User;
import com.assign.data.jpa.repository.RoleRepository;
import com.assign.data.jpa.repository.UserRepository;
import com.assign.security.jwt.JwtProvider;



/**
 * This is the main controller implemented  User Registration, authentication, Upload images, 
 *  View images and Delete images from third party imgurAPI
 * @author admin
 * 
 *
 */
...
public class APIAuthController {
    ...
    public JsonResponse deleteFiletoImgur(@Valid @RequestBody LoginForm loginRequest) {
    ...
    public JsonResponse viewFiletoImgur(@Valid @RequestBody LoginForm loginRequest) {
		if(loginRequest.getUsername()==null) { 
	          return new JsonResponse(null,"Fail -> Username is required!","uploaded.failure",false);
			}
	  	  if(loginRequest.getPassword()==null) { 
